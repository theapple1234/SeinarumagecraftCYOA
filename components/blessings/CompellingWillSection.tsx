        ...
        <section>
            ...
            <div className="mt-16 px-4 lg:px-8">
                ...
                <div 
                    ...
                    onClick={!isTelekineticsBoostDisabled ? () => ctx.handleToggleBoost('telekinetics') : undefined}
                >
            ...
            <div className="mt-16 px-4 lg:px-8">
                <SectionHeader>METATHERMICS</SectionHeader>
                 <div 
                    ...
                    onClick={!isMetathermicsBoostDisabled ? () => ctx.handleToggleBoost('metathermics') : undefined}
                >
                    <div className="flex items-center justify-center gap-4">
