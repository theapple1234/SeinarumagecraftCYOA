...
export const GoodTidingsSection: React.FC = () => {
    const {
        ...
        availableSigilCounts, handleToggleBoost, isMinorBoonsBoosted, isMajorBoonsBoosted,
    } = useCharacterContext();
        ...
        <section>
            ...
            <div className="mt-16 px-4 lg:px-8">
                ...
                <div 
                    ...
                    onClick={!isMinorBoostDisabled ? () => handleToggleBoost('minorBoons') : undefined}
                    role="button"
            ...
            <div className="mt-16 px-4 lg:px-8">
                <SectionHeader>MAJOR BOONS</SectionHeader>
                 <div 
                    ...
                    onClick={!isMajorBoostDisabled ? () => handleToggleBoost('majorBoons') : undefined}
                    role="button"
